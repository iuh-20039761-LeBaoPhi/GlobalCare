...
function loadProviders() {
    Promise.all([
        fetch('api/admin/manage-providers.php?action=list').then(r => r.json()),
        fetch('api/admin/manage-providers.php?action=counts').then(r => r.json())
    ]).then(([listRes, cntRes]) => {
...
function callAction(id, action, reason) {
    ...
    fetch(`api/admin/manage-providers.php?action=${action}`, {
        method: 'POST',
