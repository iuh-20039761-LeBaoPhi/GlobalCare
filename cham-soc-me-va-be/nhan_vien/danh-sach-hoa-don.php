                    ...
                    <form method="get" class="filter-box mb-3">
                        <div class="row g-2 align-items-end">
                            ...
                            <div class="col-6 col-md-3 col-lg-2 d-flex gap-2">
                                ...
                                <a class="btn btn-outline-secondary" href="danh-sach-hoa-don.php"><i
                        ...
                        <div class="table-responsive d-none d-md-block">
                            <table class="table jobs-table align-middle">
                                ...
                                <tbody>
                                    <?php if ($loadError !== ''): ?>
                                        <tr>
                                            <td colspan="6" class="empty-row py-4">Loi tai du lieu:
                                ...
                                <?php foreach ($paginatedRows as $item): ?>
                                    ...
                                    <a href="<?= $detailUrl ?>" class="invoice-card"
                                        ...
                                        <div class="d-flex justify-content-between align-items-center mt-1">
                                            ...
                                            <span
                                                class="inv-status"><?= htmlspecialchars($statusValue, ENT_QUOTES, 'UTF-8') ?></span>
                                        </div>
                                    ...
                                    <ul class="pagination pagination-sm mb-0">
                                        ...
                                        <?php for ($i = 1; $i <= $totalPages; $i++): ?>
                                            <li class="page-item <?= $i === $page ? 'active' : '' ?>">
                                                <a class="page-link"
                                                    href="<?= htmlspecialchars($buildPageUrl($i), ENT_QUOTES, 'UTF-8') ?>"><?= $i ?></a>
                                            </li>
                                        <?php endfor; ?>
                                        <li class="page-item <?= $page >= $totalPages ? 'disabled' : '' ?>">
                                            <a class="page-link"
                                                href="<?= htmlspecialchars($buildPageUrl(min($totalPages, $page + 1)), ENT_QUOTES, 'UTF-8') ?>">Sau</a>
                                        </li>
                                    </ul>
                                </nav>
                            <?php endif; ?>
