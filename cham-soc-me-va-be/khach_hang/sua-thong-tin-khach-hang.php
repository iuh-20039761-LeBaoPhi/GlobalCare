...
<main class="page-wrap">
    ...
    <section class="edit-shell">
        <div class="edit-head">
            ...
            <p class="edit-sub">Xu ly bang PHP, cap nhat vao bang khachhang qua API KRUD.</p>
        </div>
        <div class="edit-body">
            <form class="form-box" method="post" action="xu-ly-sua-thong-tin-khach-hang.php" enctype="multipart/form-data">
                ...
                <div class="tip mb-3">
                    Form theo dung cot bang khachhang: hovaten, email, sodienthoai, matkhau, diachi, ngaysinh, anh_dai_dien, cccd_mat_truoc, cccd_mat_sau.
                </div>

                <div class="row g-3">
                    <div class="col-12 col-md-6">
                        <label class="form-label">ID khach hang</label>
                        <input type="text" class="form-control" value="<?= (int)$customerId ?>" readonly>
                    </div>
                    <div class="col-12 col-md-6">
