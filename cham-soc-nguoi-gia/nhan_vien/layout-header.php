...
$userAvatar = $_SESSION['user']['avatartenfile'] ?? 'logong.png';
if (strpos($userAvatar, 'assets/') === false && $userAvatar !== 'logong.png') {
    $userAvatar = '../assets/' . $userAvatar;
} else if ($userAvatar === 'logong.png') {
    $userAvatar = '../assets/logong.png';
}
