...
<head>
    <meta charset="UTF-8">
    <title>Đặt vệ sinh văn phòng | Vệ sinh Care</title>
...
<section class="service-banner">
    <div class="content">
        <h2>Đặt dịch vụ vệ sinh văn phòng</h2>
        <p>
            Giữ không gian làm việc luôn sạch sẽ – chuyên nghiệp – tạo ấn tượng tốt
...
<section class="container">
    ...
    <h3 class="form-title">Địa chỉ văn phòng</h3>
    ...
    <div class="service-card active" data-value="Vệ sinh văn phòng">
        🏢
        <h4>Vệ sinh văn phòng</h4>
        <p>Lau dọn – khử khuẩn – giữ môi trường làm việc sạch sẽ</p>
    </div>

    <input type="hidden" id="service" name="service_type" value="Vệ sinh văn phòng">

    <h3 class="form-title">Thời gian & ghi chú</h3>

    <input type="date" id="date" name="booking_date" required>
    <textarea id="note" name="note"
        placeholder="Ghi chú thêm (diện tích, số phòng, thời gian mong muốn...)"></textarea>
...
<div id="successModal" class="modal">
    <div class="modal-content">
        ...
        <p>
            Chúng tôi đã nhận được thông tin đặt dịch vụ vệ sinh văn phòng.<br>
