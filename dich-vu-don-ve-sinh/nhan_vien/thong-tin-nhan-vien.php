...
<style>
    ...
    body {
        background:
            radial-gradient(1200px 500px at 10% -10%, #e0f2fe 0%, transparent 55%),
            radial-gradient(900px 440px at 100% 0%, #f0f9ff 0%, transparent 52%),
    ...
    .profile-head {
        background: linear-gradient(110deg, #1e40af 0%, #2563eb 68%, #60a5fa 100%);
    ...
    .alert-danger {
        ...
        background: #fef2f2;
        border-color: #fecaca;
        box-shadow: 0 8px 16px rgba(153, 27, 27, 0.08);
    }
</style>
