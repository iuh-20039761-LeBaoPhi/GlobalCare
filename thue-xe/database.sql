-- =====================================================
-- CarRental Database Schema (Minimal)
-- Chỉ lưu: đơn đặt xe, admin, liên hệ
-- Dữ liệu xe & dịch vụ được lấy từ static-data.js
-- =====================================================
...
-- Đơn đặt xe mẫu
INSERT INTO bookings (car_id, car_name, customer_name, customer_email, customer_phone, customer_address, id_number, pickup_date, return_date, pickup_location, notes, total_days, total_price, status, created_at) VALUES

(1, 'Toyota Camry 2023', 'Nguyễn Văn An', 'nguyenvanan@gmail.com', '0901234567',
...
(2, 'Honda CR-V 2022', 'Trần Thị Bích', 'tranthibich@gmail.com', '0912345678',
...
(6, 'VinFast VF8 2023', 'Lê Minh Khoa', 'leminhkhoa@gmail.com', '0978901234',
...
(8, 'Mazda CX-5 2023', 'Phạm Quỳnh Anh', 'phamquynhanh@gmail.com', '0934567890',
...
(7, 'Honda City 2023', 'Hoàng Đức Trung', 'hoangductrung@gmail.com', '0945678901',
...
(4, 'Ford Ranger 2022', 'Vũ Thị Lan', 'vuthilan@gmail.com', '0956789012',
...
(9, 'Mazda 3 2023', 'Đỗ Thanh Tùng', 'dothanhtung@gmail.com', '0967890123',
...
(10, 'Toyota Vios 2023', 'Ngô Thị Mai', 'ngothimai@gmail.com', '0989012345',
...
(5, 'Mitsubishi Xpander 2023', 'Bùi Văn Hùng', 'buivanhung@gmail.com', '0901112233',
